...
namespace MyLeasing.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("01919707-6", "Miguel Eduardo", "Aguilar Machon", "miguelmachon@gmail.com", "77406207", "Santa Ana", "Manager");
            var owner = await CheckUserAsync("01919707-6", "Miguel Owner", "Aguilar Machon", "miguelmachon@outlook.com", "77406207", "Santa Ana", "Owner");
            var lessee = await CheckUserAsync("01919707-6", "Miguel Lessee", "Aguilar Machon", "aguilarmachon@gmail.com", "77406207", "Santa Ana", "Lessee");
        ...
        private async Task CheckPropertiesAsync()
        {
            ...
            {
                AddProperty("C.La Ronda Urb.La Ronda Senda B #14-B", "Santa ana", owner, propertyType, 12000M, 2, 72, 4);
                AddProperty("Av.Independencia #13 Col.Ivu", "Envigado", owner, propertyType, 60000M, 3, 81, 3);
                await _context.SaveChangesAsync();
            }
        }
        ...
        private void AddProperty(string address,
            ...
            decimal price, int rooms, 
            int squareMeters, int stratum)
        {
